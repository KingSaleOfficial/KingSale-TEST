...
export default function PromotList() {
  ...
  const activeBlockRuleEvent = async (id) => {
    ...
    await axios({
      method: "GET",
      url: apiConfig.presaleListAdmin,
    ...
    <Page title='KYC'>
      <>
        {/* <Box pt={0} textAlign="center" mb={3} className="mainBox">
          <Box mb={3}>
            <Typography variant="h5"> Promot Pre-sale List</Typography>
          </Box>
        </Box> */}
                      ...
                      return (
                        <>
                          <TableRow key={i}>
                            ...
                            >
                              {/* {
                                moment(data?.startTime).format("ll") //   .format("lll")
                              } */}
                              {/* {new Date(data?.startTime * 1000).toString()} */}
                            ...
                            <TableCell
                              ...
                              className='table-data'
                            >
                              {/* {moment(data?.endTime).unix()} */}
                              {/* {new Date(data?.endTime * 1000).toString()} */}
