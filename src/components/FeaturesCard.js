...
import {
    Box, Typography, Grid, Button, Link
        ...
        <Box className={classes.mainBox} >
            ...
            <Box className={classes.nameBox}>
                <Box>
                    ...
                    <Typography variant="body2">Pool unlocks Dec 2, 10:30 EST</Typography>
                </Box>
            ...
            <Box className={classes.apyBox}>
                <Grid container spacing={2} alignItems="center">
                    ...
                    <Grid item xs={6}>
                        <Button className={classes.manualBtn}> <IoMdRefresh /> Manual</Button>
                    </Grid>
                    <Grid item xs={6} align="right">
                        <Typography variant="h4">Details <BiChevronDown /> </Typography>
                    </Grid>
                    <Grid item xs={6}>
                        <Typography variant="body2" style={{ color: "#fff" }}>Total staked:</Typography>
                    </Grid>
                    <Grid item xs={6} align="right">
                        <input type="text" />
                        <Link href="#" className={classes.viewLink}>View Contract <HiOutlineExternalLink /></Link>
                    </Grid>
                </Grid>
            </Box>
        </Box>
